          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="border-b border-border/50 pb-4">
              <AccordionTrigger className="text-lg font-semibold text-foreground hover:text-primary">
                Jak zacząć sprzedawać na MarketHub?
              </AccordionTrigger>
            ...
            <AccordionItem value="item-4" className="border-b border-border/50 pb-4">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed pt-2">
                Wystawienie produktu na MarketHub jest całkowicie darmowe! Pobieramy jedynie małą prowizję od 
            ...
            <AccordionItem value="item-10" className="border-b border-border/50 pb-4">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed pt-2">
                ...
                Jeśli to nie pomoże, skontaktuj się z naszym zespołem wsparcia pod adresem support@markethub.pl - 
            ...
            <AccordionItem value="item-11" className="border-b border-border/50 pb-4">
              ...
              <AccordionContent className="text-muted-foreground leading-relaxed pt-2">
                Tak! MarketHub jest świetnym miejscem do sprzedaży produktów używanych. Po prostu uczciwie opisz stan 
          ...
          <div className="mt-8 rounded-xl bg-gradient-to-br from-primary/10 to-accent/10 border border-primary/30 p-6">
            ...
            <div className="space-y-2 text-sm">
              <p className="text-muted-foreground">
                📧 Email: <span className="text-foreground font-semibold">support@markethub.pl</span>
              </p>
              <p className="text-muted-foreground">
