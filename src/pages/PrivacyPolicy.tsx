        ...
        <div className="space-y-8 rounded-2xl bg-card/50 backdrop-blur-sm border border-border/50 p-8 shadow-xl">
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              VelvetBazzar.co.uk zobowiązuje się do ochrony prywatności użytkowników. Niniejsza polityka prywatności wyjaśnia, 
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              W sprawach dotyczących ochrony danych osobowych prosimy o kontakt: privacy@velvetbazzar.co.uk
            </p>
          </section>
