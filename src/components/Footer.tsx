    ...
    <footer className="relative border-t border-border/50 bg-gradient-to-br from-muted/30 via-background to-muted/20 backdrop-blur-sm">
      ...
      <div className="container py-16 relative">
        <div className="grid gap-12 md:grid-cols-5">
          <div className="space-y-4">
            <div className="flex items-center space-x-3 group">
              ...
              <span className="text-2xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">VelvetBazzar.co.uk</span>
            </div>
        ...
        <div className="mt-12 border-t border-border/50 pt-8 text-center">
          <p className="text-sm text-muted-foreground">&copy; 2025 <span className="font-semibold text-foreground">VelvetBazzar.co.uk</span>. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
