...
for (const asset of assets) {
  ...
  const project = js.includes("nmgiyvauguilbwtqlexj");
...
const res = await fetch("https://nmgiyvauguilbwtqlexj.supabase.co/functions/v1/auth-signup", {
  method: "POST",
  headers: {
    apikey: anon,
...
const loginRes = await fetch(
  "https://nmgiyvauguilbwtqlexj.supabase.co/auth/v1/token?grant_type=password",
  {
    method: "POST",
    headers: {
      apikey: anon,
